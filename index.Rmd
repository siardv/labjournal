...
- Week 4
  - Generated node list and edge list data frames for co-authorship network
  - Calculated basic network metrics like degree centrality and clustering coefficients
  - Produced static network visualization using igraph package
  - Started dynamic network modeling with RSiena but need to resolve model specification issues
  
- Week 5 
  - Improved RSiena model specification based on goodness-of-fit diagnostics
  - Finalized model incorporating key structural effects and attributes
  - Ran final models and produced estimates of gender homophily effects
  - Evaluated hypothesis tests and effect sizes from model output
  - Began drafting results and discussion based on model findings
